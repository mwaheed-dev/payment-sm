...
public class PackageQuotas implements Serializable {
    ...
    @ManyToOne
    private Packages customerQuotas;
    ...
    public Packages getCustomerQuotas() {
        return this.customerQuotas;
    }

    public void setCustomerQuotas(Packages packages) {
        this.customerQuotas = packages;
    }

    public PackageQuotas customerQuotas(Packages packages) {
        this.setCustomerQuotas(packages);
        return this;
    }
