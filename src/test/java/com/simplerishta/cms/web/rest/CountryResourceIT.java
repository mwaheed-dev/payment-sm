...
import com.simplerishta.cms.repository.CountryRepository;
import com.simplerishta.cms.service.dto.CountryDTO;
import com.simplerishta.cms.service.mapper.CountryMapper;
...
class CountryResourceIT {
    ...
    public static Country createEntity(EntityManager em) {
        Country country = new Country().name(DEFAULT_NAME).urduName(DEFAULT_URDU_NAME);
        return country;
    }
    ...
    public static Country createUpdatedEntity(EntityManager em) {
        Country country = new Country().name(UPDATED_NAME).urduName(UPDATED_URDU_NAME);
        return country;
    }
    ...
    void createCountry() throws Exception {
        ...
        assertThat(testCountry.getUrduName()).isEqualTo(DEFAULT_URDU_NAME);
    }
    ...
    void putExistingCountry() throws Exception {
        ...
        updatedCountry.name(UPDATED_NAME).urduName(UPDATED_URDU_NAME);
        ...
        assertThat(testCountry.getUrduName()).isEqualTo(UPDATED_URDU_NAME);
    }
    ...
    void partialUpdateCountryWithPatch() throws Exception {
        ...
        partialUpdatedCountry.name(UPDATED_NAME).urduName(UPDATED_URDU_NAME);
