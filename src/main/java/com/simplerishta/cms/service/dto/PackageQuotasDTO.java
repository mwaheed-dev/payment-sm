...
public class PackageQuotasDTO implements Serializable {
    ...
    private PackagesDTO packageQuotas;
    ...
    public PackagesDTO getPackageQuotas() {
        return packageQuotas;
    }

    public void setPackageQuotas(PackagesDTO packageQuotas) {
        this.packageQuotas = packageQuotas;
    }
    ...
    public String toString() {
        return "PackageQuotasDTO{" +
            ...
            ", packageQuotas=" + getPackageQuotas() +
            "}";
    }
}
