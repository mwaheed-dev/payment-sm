    ...
    plugins: [
      new ModuleFederationPlugin({
        ...
        shared: {
          ...
          '@angular/core': { singleton: true, strictVersion: true, requiredVersion: '14.1.0' },
          '@angular/common': { singleton: true, strictVersion: true, requiredVersion: '14.1.0' },
          '@angular/common/http': { singleton: true, strictVersion: true, requiredVersion: '14.1.0' },
          '@angular/router': { singleton: true, strictVersion: true, requiredVersion: '14.1.0' },
          '@angular/forms': { singleton: true, strictVersion: true, requiredVersion: '14.1.0' },
          '@angular/platform-browser': { singleton: true, strictVersion: true, requiredVersion: '14.1.0' },
          ...
          '@fortawesome/fontawesome-svg-core': { singleton: true, strictVersion: true, requiredVersion: '6.1.2' },
          ...
          dayjs: { singleton: true, strictVersion: true, requiredVersion: '1.11.4' },
